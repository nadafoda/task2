...
document.getElementById('p-1').innerText = posts[0].contents;
...
document.getElementById('p-2').innerText = posts[1].contents;
...
document.getElementById('p-3').innerText = posts[2].contents;
